...
%%
%% usage: [ALPHA] = fcn_0To90TimeConstantToAlpha(TIME, FS, BLOCKSIZE)
%%
%% Calculates the correct ALPHA value for exponential smoothing filter (1st 
%% order low-pass) to obtain a step response going from 0% to 90% of 
...
function [ALPHA] = fcn_0To90TimeConstantToAlpha(TIME, FS, BLOCKSIZE)
    ALPHA = 0.1 ^ (BLOCKSIZE / (TIME * FS));
end
