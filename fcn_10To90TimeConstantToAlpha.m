...
%%
%% usage: [ALPHA] = fcn_10To90TimeConstantToAlpha(TIME, FS, BLOCKSIZE)
%%
%% Calculates the correct ALPHA value for exponential smoothing filter (1st 
%% order low-pass) to obtain a step response going from 10% to 90% of 
...
function [ALPHA] = fcn_10To90TimeConstantToAlpha(TIME, FS, BLOCKSIZE)
    ALPHA = (0.1 / 0.9) ^ (BLOCKSIZE / (TIME * FS));
end
